...
def _send_order_ready_for_payment_email(order_id):
    ...
    message = (
        ...
        "<p style=\"margin:0 0 12px 0;\">Twoje zamówienie oczekuje na przelew.</p>"
        f"<p style=\"margin:0 0 12px 0;\">Do zapłaty: <strong>{left_to_pay_display} zł</strong></p>"
        "<p style=\"margin:0 0 8px 0;\">Przelew na dane:</p>"
...
def api_assign_contributions_to_order(request):
    ...
    with transaction.atomic():
        ...
        transaction.on_commit(lambda: email_delivery.update(_send_order_ready_for_payment_email(order.id)))
