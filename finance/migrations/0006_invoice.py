# Generated by Django 5.1.3 on 2025-03-06 10:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='invoices', to='stock.supplier')),
            ],
            options={
                'ordering': ['-created_at'],
            },
