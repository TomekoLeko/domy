...
urlpatterns = [
    ...
    path('api/shipments/all/', views.api_list_all_shipments, name='api_list_all_shipments'),
    path('api/shipments/create/', views.api_create_shipment, name='api_create_shipment'),
    path(
        'api/shipments/assign-items/',
        views.api_assign_order_items_to_shipments,
        name='api_assign_order_items_to_shipments',
    ),
