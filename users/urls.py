...
urlpatterns = [
    ...
    path('api/auth/account/', views.api_get_my_account, name='api_get_my_account'),
    ...
    path(
        'api/users/<int:user_id>/shipping-address/',
        views.api_user_shipping_address,
        name='api_user_shipping_address',
    ),
    path(
