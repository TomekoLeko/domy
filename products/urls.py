...
urlpatterns = [
    ...
    path('api/orders/<int:order_id>/', views.api_get_order_details, name='api_get_order_details'),
    path('api/orders/payment/', views.api_submit_payment, name='api_submit_payment'),
    ...
    path('orders/settle/<int:order_id>/', views.settle_order, name='settle_order'),
]
